...
public class TopicDataModelImp extends BaseModel implements TopicDataModel<TopicInfoRet> {
    ...
    public TopicDataModelImp(Context mContext) {
        super();
        context = mContext;
    ...
    public void getTopicDataList(final IBaseRequestCallBack<TopicInfoRet> iBaseRequestCallBack) {
        ...
        mCompositeSubscription.add(topicDataServiceApi.getTopicDataList(requestBody)  //将subscribe添加到subscription，用于注销subscribe
                .observeOn(AndroidSchedulers.mainThread())//指定事件消费线程
                .subscribeOn(Schedulers.io())  //指定 subscribe() 发生在 IO 线程
                .subscribe(new Subscriber<TopicInfoRet>() {
